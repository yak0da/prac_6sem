"""Tests for user input -> wire protocol (client only, no server)."""
...
class TestAddmonCommand(unittest.TestCase):
    ...
    def test_addmon_coords_1_2(self):
        hello = "Hi there"
        self.mud.onecmd(f'addmon dragon hello "{hello}" hp 10 coords 1 2')
        expected = f"addmon {shlex.quote(hello)} 10 dragon 1 2\n"
